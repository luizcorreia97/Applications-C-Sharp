...
<body>
    ...
    <form id="form2" runat="server">
        <div class="container">
            ...
            <br />
            <asp:DataGrid ID="gridAluno" runat="server" CssClass="table table-hover table-striped" Width="100%" OnItemCommand="gridAluno_ItemCommand" AutoGenerateColumns="False" OnPageIndexChanged="gridAluno_PageIndexChanged" PageSize="3" AllowPaging="True" CellPadding="4" GridLines="None">
                <Columns>
